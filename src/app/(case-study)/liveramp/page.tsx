        ...
        <div className={clsx(shared.content, styles.content)}>
          <div className={clsx(shared.desc, styles.desc)}>
            <p className={styles.desc1}>
              ...
              form controls through to global navigation, rich data tables, and
              data display components. Designed from the ground up with an
            ...
            <p className={styles.desc2}>
              ...
              migrations, with a full Storybook documentation suite; clear usage
              patterns, code examples, and accessibility guidance baked in from
              the start.
            </p>
            <p className={styles.desc3}>
              ...
              establishing a shared frontend language that hundreds of engineers
              relied on daily.
            </p>
          </div>
          ...
          <dl className={clsx(shared.details, styles.details)}>
            <div>
              ...
              <dd>React · TypeScript · Material UI · Emotion · CSS Modules</dd>
            </div>
            <div>

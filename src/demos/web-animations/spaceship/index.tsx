...
export default function Spaceship() {
  ...
  return (
    <div className={styles.container}>
      <svg viewBox="0 0 400 250" aria-labelledby="title" role="img">
        ...
        <defs>
          ...
          >
            <stop offset="0" stopColor="#4e699a" />
            <stop offset="0.7" stopColor="#4e699a" stopOpacity="0.5" />
            <stop offset="1" stopColor="#4e699a" stopOpacity="0.2" />
          </linearGradient>
        </defs>
